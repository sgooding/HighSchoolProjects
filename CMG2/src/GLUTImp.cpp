...
void GLUTImp::ImageInstance::jpegload(const char *cpFileName, unsigned short *uspWidth, unsigned short *uspHeight, unsigned char **ucpImageData) {
  ...
  std::cout << "Trying to open : " << cpFileName << std::endl;
  ...
  *ucpImageData = new unsigned char[ulDataWidth * (*uspHeight)];
  ...
  std::cout << "Processed JPEG Image" << std::endl;
  fclose(fInput);
}
#endif //HAVE_LIBJPEG
...
#if 1
    gluTessCallback(tesselator, (GLenum)(GLU_VERTEX), (void (*) ()) GLUTImp::handleTessVertex);
    gluTessCallback(tesselator, (GLenum)(GLU_ERROR), (void (*) ()) GLUTImp::handleTessError);
    gluTessCallback(tesselator, (GLenum)(GLU_BEGIN), (void (*) ()) GLUTImp::handleTessBegin);
    gluTessCallback(tesselator, (GLenum)(GLU_END), (void (*) ()) GLUTImp::handleTessEnd);
#endif
...
#if 1
void  GLUTImp::handleTessError(int error) {
  switch((GLenum) error) {
